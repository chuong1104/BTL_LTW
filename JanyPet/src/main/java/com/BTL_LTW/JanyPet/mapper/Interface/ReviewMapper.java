...
public interface ReviewMapper extends GenericMapper<Review, ReviewResponse, ReviewCreateRequest, ReviewUpdateRequest> {
    ...
    interface OrderMapper extends GenericMapper<Order, OrderResponse, OrderCreateRequest, OrderStatusUpdateRequest> {
        // Phương thức bổ sung để tạo summary response cho hiển thị danh sách
