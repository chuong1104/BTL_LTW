...
// If authService already exists, add to it, otherwise create it
window.authService = window.authService || {};

// Add checkLoginStatus method if it doesn't exist
if (!window.authService.checkLoginStatus) {
    window.authService.checkLoginStatus = function() {
