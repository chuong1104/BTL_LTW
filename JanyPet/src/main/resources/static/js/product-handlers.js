...
const ProductHandlers = {
    ...
    loadProducts: async function() {
        try {
            ...
            const tableBody = document.getElementById('products-table-body');
            if (tableBody) {
                tableBody.innerHTML = '<tr><td colspan="8" class="text-center text-danger">Error loading products. Please try again later.</td></tr>';
            }
        }
    },
    ...
    deleteProduct: async function() {
        try {
            ...
            // Hiển thị thông báo thành công
            window.toastService?.showToast('success', 'Product deleted successfully!');
            ...
            window.toastService?.showToast('error', `Error: ${error.message}`);
        }
    },
